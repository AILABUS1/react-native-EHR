  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#F8FAFC" }}>
      <ScrollView className="flex-1 px-6 py-8" contentContainerStyle={{ flexGrow: 1 }}>
        <View className="mb-7 rounded-[32px] bg-slate-100 px-5 py-5 shadow-sm">
        ...
        <View className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <View className="mt-6 flex-row flex-wrap justify-between gap-3">
            <View className="rounded-3xl bg-slate-100 px-4 py-3 shadow-sm">
              <Text className="text-sm font-semibold text-slate-900">Hello!</Text>
            </View>
            <View className="rounded-3xl bg-violet-100 px-4 py-3 shadow-sm">
              <Text className="text-sm font-semibold text-violet-800">¡Hola!</Text>
            </View>
            <View className="rounded-3xl bg-rose-100 px-4 py-3 shadow-sm">
              <Text className="text-sm font-semibold text-rose-800">你好!</Text>
            </View>
          </View>

          <View className="mt-8 items-center">
            <View className="w-full max-w-[360px] overflow-hidden rounded-[28px] bg-white shadow-2xl shadow-slate-200/80">
              <Image
        ...
        <View className="mt-8 space-y-3 rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm">
